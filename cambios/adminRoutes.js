...
const { proteger, esAdministrador } = require('../backend/middleware/authMiddleware');
const {
...
} = require('../backend/controllers/clasesController');
...
const {
  ...
  actualizarUsuario,
  eliminarUsuario,
} = require('../backend/controllers/usuariosController');
...
} = require('../backend/controllers/reservasController');
